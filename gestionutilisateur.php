...
$sql = "SELECT id_utilisateur, nom__utilisateur, prenom_utilisateur, email_utilisateur, statut FROM utilisateur WHERE role = 'user'";
    ...
    <table class="user-table">
        ...
        <tbody>
            <?php while ($row = $result->fetch_assoc()): ?>
                ...
                <td>
                    <form method="POST" action="changer_statut_utilisateur.php" onsubmit="return confirm('Êtes-vous sûr de vouloir changer le statut de cet utilisateur ?');">
                        <input type="hidden" name="id_utilisateur" value="<?php echo $row['id_utilisateur']; ?>">
                        <input type="hidden" name="nouveau_statut" value="<?php echo $row['statut'] == 'actif' ? 'bloque' : 'actif'; ?>">
                        <button type="submit"><?php echo $row['statut'] == 'actif' ? 'Bloquer' : 'Débloquer'; ?></button>
                    </form>
                </td>
                </tr>
            <?php endwhile; ?>
